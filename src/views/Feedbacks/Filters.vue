    ...
    <ul class="flex flex-col mt-3 list-none">
      ...
      >
        <div class="flex items-center">
          <!-- pega a cor definida pela função abaixo -->
          <span
...
function applyFilterStructure (summary) {
  return Object.keys(summary).reduce((accumulated, current) => {
    const currentFilter = {
    ...
    return [...accumulated, currentFilter]
  }, [])
}
